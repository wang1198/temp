...
public class QuartzManager {
    ...
    private static String JOB_GROUP_NAME = "JOBGROUP_DEFAULT";                    //任务组
    private static String TRIGGER_GROUP_NAME = "TRIGGERGROUP_DEFAULT";            //触发器组
    ...
    public void addJob(String jobName, String jobGroupName,
                       ...
                       String time) {
        try {
            JobDetail jobDetail;// 任务名，任务组，任务执行类
    ...
    public void removeJob(String jobName) {
        try {
            TriggerKey triggerKey;    //通过触发器名和组名获取TriggerKey
